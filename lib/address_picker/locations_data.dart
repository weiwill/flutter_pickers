...
class AddressService {
  ...
  List<MapEntry<String, String>> getTowns(
    ...
    List<MapEntry<String, String>> areaList =
        locations[city.key].entries.toList();
  ...
  List<String> getCityCodeByName(
    ...
    List<String> cityCode = [null, null, null];
    ...
    if (PicketUtil.strNoEmpty(initialProvinceCode)) {
      ...
      cityCode.fillRange(0, 1, initialProvinceCode);
      ...
      if (PicketUtil.strNoEmpty(initialCityCode)) {
        ...
        cityCode.fillRange(1, 2, initialProvinceCode);
        ...
        if (PicketUtil.strNoEmpty(initialTownCode)) {
          ...
          cityCode.fillRange(2, 3, initialProvinceCode);
        }
      }
    }
    // print('longer 区域代码 >>> $cityCode');
  ...
  List<String> getCityNameByCode(
    ...
    if (PicketUtil.strNoEmpty(provinceName)) {
      ...
      cityName.fillRange(0, 1, provinceName);
      ...
      if (PicketUtil.strNoEmpty(initialCityName)) {
        ...
        cityName.fillRange(1, 2, initialCityName);
        ...
        if (PicketUtil.strNoEmpty(initialTownName)) {
          ...
          cityName.fillRange(2, 3, initialTownName);
        }
      }
    }
    // print('longer 区域名 >>> $cityName');
